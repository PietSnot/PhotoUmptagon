...
function init() {
    ...
    currentPerspective = data.startPerspectieve;
    currentZvalue = data.startZ;
    
    document.getElementsByClassName('speelveld')[0].style.perspective = currentPerspective + 'px';
